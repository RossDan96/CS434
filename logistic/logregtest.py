...
epsilon = 600.0 #exit condition
loop = 0 #count of loops
maxpow = (math.log(sys.float_info.max))-eta
minpow = (math.log(sys.float_info.min))+eta
print maxpow
print minpow
exbool = True
...
for i in range(testEx):
	...
	if (round(ytest,1) == y[i,0]):
		...
		print y[i,0]
print "Percentage"
print (float(correct/float(testEx)))*100
